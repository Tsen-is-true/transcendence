...
export function Register() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (!usernameRegex.test(username)) {
      setError('Username must contain only alphanumeric characters or Korean');
      return;
    }
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:outline-none focus:border-purple-500 transition-colors"
